...
export default function SiteNav() {
  return (
    ...
    >
      <div
        class="container mx-auto flex flex-row items-center py-5 px-5 md:px-2"
      >
        <nav
        ...
        >
          ...
          <SiteNavLink href="https://soulection.supply/" rel="noopener" target="_blank">Supply</SiteNavLink>
          <SiteNavLink href="/about/">About</SiteNavLink>
          <SiteNavLink href="https://soulection.plus" rel="noopener" target="_blank">Soulection<sup>+</sup></SiteNavLink>
        </nav>
      </div>
    </header>
  )
